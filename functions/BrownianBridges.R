...
setwd('C:/Users/Administrator/OneDrive - University of Glasgow/Serengeti Wildebeest Project/SerengetiGIS/V4_Serengeti_Ecosystem')
snp  <- readOGR(dsn='.','v4_serengeti_ecosystem')
